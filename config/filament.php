...
return [
    ...
    */
    ...
    'developer_login_enabled' => env('DEVELOPER_LOGIN_ENABLED', false),

    'has_email_verification' => env('FILAMENT_HAS_EMAIL_VERIFICATION', false),

    'mfa' => [
        'enabled' => env('FILAMENT_MFA_ENABLED', false),

        'email' => env('FILAMENT_MFA_EMAIL', true),
        'app' => env('FILAMENT_MFA_APP', false),

        'required' => env('FILAMENT_MFA_REQUIRED', false),
    ],
